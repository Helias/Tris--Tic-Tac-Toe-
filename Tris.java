...
public class Tris extends javax.swing.JFrame {
    ...
    public void Player2()
    {
        Giocatore=2;
        int r=(int)((Math.random()*9)+1);
	if(scacchiera[1]==0 & scacchiera[2]==2 & scacchiera[3]==2){r=1;}
	else if(scacchiera[1]==2 & scacchiera[2]==0 & scacchiera[3]==2){r=2;}
	else if(scacchiera[1]==2 & scacchiera[2]==2 & scacchiera[3]==0){r=3;}
	else if(scacchiera[4]==0 & scacchiera[5]==2 & scacchiera[6]==2){r=4;}
	else if(scacchiera[4]==2 & scacchiera[5]==0 & scacchiera[6]==2){r=5;}
	else if(scacchiera[4]==2 & scacchiera[5]==2 & scacchiera[6]==0){r=6;}
	else if(scacchiera[7]==0 & scacchiera[8]==2 & scacchiera[9]==2){r=7;}
	else if(scacchiera[7]==2 & scacchiera[8]==0 & scacchiera[9]==2){r=8;}
	else if(scacchiera[7]==2 & scacchiera[8]==2 & scacchiera[9]==0){r=9;}
	else if(scacchiera[1]==0 & scacchiera[5]==2 & scacchiera[9]==2){r=1;}
	else if(scacchiera[1]==2 & scacchiera[5]==0 & scacchiera[9]==2){r=5;}
	else if(scacchiera[1]==2 & scacchiera[5]==2 & scacchiera[9]==0){r=9;}
	else if(scacchiera[3]==0 & scacchiera[5]==2 & scacchiera[7]==2){r=3;}
	else if(scacchiera[3]==2 & scacchiera[5]==0 & scacchiera[7]==2){r=5;}
	else if(scacchiera[3]==2 & scacchiera[5]==2 & scacchiera[7]==0){r=7;}
	else if(scacchiera[1]==0 & scacchiera[4]==2 & scacchiera[7]==2){r=1;}
	else if(scacchiera[1]==2 & scacchiera[4]==0 & scacchiera[7]==2){r=4;}
	else if(scacchiera[1]==2 & scacchiera[4]==2 & scacchiera[7]==0){r=7;}
	else if(scacchiera[2]==0 & scacchiera[5]==2 & scacchiera[8]==2){r=2;}
	else if(scacchiera[2]==2 & scacchiera[5]==0 & scacchiera[8]==2){r=5;}
	else if(scacchiera[2]==2 & scacchiera[5]==2 & scacchiera[8]==0){r=8;}
	else if(scacchiera[3]==0 & scacchiera[6]==2 & scacchiera[9]==2){r=3;}
	else if(scacchiera[3]==2 & scacchiera[6]==0 & scacchiera[9]==2){r=6;}
	else if(scacchiera[3]==2 & scacchiera[6]==2 & scacchiera[9]==0){r=9;}
	else
	{
		if(scacchiera[1]==0 & scacchiera[2]==1 & scacchiera[3]==1){r=1;}
		else if(scacchiera[1]==1 & scacchiera[2]==0 & scacchiera[3]==1){r=2;}
		else if(scacchiera[1]==1 & scacchiera[2]==1 & scacchiera[3]==0){r=3;}
		else if(scacchiera[4]==0 & scacchiera[5]==1 & scacchiera[6]==1){r=4;}
		else if(scacchiera[4]==1 & scacchiera[5]==0 & scacchiera[6]==1){r=5;}
		else if(scacchiera[4]==1 & scacchiera[5]==1 & scacchiera[6]==0){r=6;}
		else if(scacchiera[7]==0 & scacchiera[8]==1 & scacchiera[9]==1){r=7;}
		else if(scacchiera[7]==1 & scacchiera[8]==0 & scacchiera[9]==1){r=8;}
		else if(scacchiera[7]==1 & scacchiera[8]==1 & scacchiera[9]==0){r=9;}
		else if(scacchiera[1]==0 & scacchiera[5]==1 & scacchiera[9]==1){r=1;}
		else if(scacchiera[1]==1 & scacchiera[5]==0 & scacchiera[9]==1){r=5;}
		else if(scacchiera[1]==1 & scacchiera[5]==1 & scacchiera[9]==0){r=9;}
		else if(scacchiera[3]==0 & scacchiera[5]==1 & scacchiera[7]==1){r=3;}
		else if(scacchiera[3]==1 & scacchiera[5]==0 & scacchiera[7]==1){r=5;}
		else if(scacchiera[3]==1 & scacchiera[5]==1 & scacchiera[7]==0){r=7;}
		else if(scacchiera[1]==0 & scacchiera[4]==1 & scacchiera[7]==1){r=1;}
		else if(scacchiera[1]==1 & scacchiera[4]==0 & scacchiera[7]==1){r=4;}
		else if(scacchiera[1]==1 & scacchiera[4]==1 & scacchiera[7]==0){r=7;}
		else if(scacchiera[2]==0 & scacchiera[5]==1 & scacchiera[8]==1){r=2;}
		else if(scacchiera[2]==1 & scacchiera[5]==0 & scacchiera[8]==1){r=5;}
		else if(scacchiera[2]==1 & scacchiera[5]==1 & scacchiera[8]==0){r=8;}
		else if(scacchiera[3]==0 & scacchiera[6]==1 & scacchiera[9]==1){r=3;}
		else if(scacchiera[3]==1 & scacchiera[6]==0 & scacchiera[9]==1){r=6;}
		else if(scacchiera[3]==1 & scacchiera[6]==1 & scacchiera[9]==0){r=9;}
	}
